...
****
# My skills
Over the course of my journey I've babbled in quite a lot of programming languages, but the ones that I can confidently say that I know how to proficiently use are: **Python**, **Lua**, **JavaScript**/**TypeScript**, and some **C++**. Although, I mostly use Python and Lua. I enjoy learning new things, especially in fields that I may not understand well.
****
